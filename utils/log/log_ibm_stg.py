...
today = date.today()
server_url = "https://stg-ticket-ibm.cloudzcp.io"
DOWNLOAD_DIR = "./"+today.strftime('%Y%m%d')+"-ibm-stg-logs"+"/"
...
def http_get(url):
    ...
    #requests module
    try:
        headers = {'authorization': '5C2XkNLcGi4vKaOdVq0s', 'Content-Type': 'application/json; charset=utf-8'}
